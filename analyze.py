...
# read raw EEG file
eeg_path = "Data/emotion/emotion-offline-[2022.11.08-12.22.22].edf"
...
N = ica.n_components_
ica.plot_properties(raw, picks=list(range(0, N)), psd_args={"fmin": 1.0, "fmax": 60.0})  # further analyze the channels
...
want_epoch = False
if want_epoch:
    epochs = mne.Epochs(raw, events, event_id=event_dict, tmin=-0.2, tmax=30,
